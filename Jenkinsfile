...
def notifyStash(String sha) {
  ...
  step([
    ...
    credentialsId: 'change_this', // Credential in Jenkins corresponds to the scm user (safe for source control)
    disableInprogressNotification: false,
    ignoreUnverifiedSSLPeer: true,
    includeBuildNumberInKey: false,
    prependParentProjectKey: false,
    projectKey: '',
    stashServerBaseUrl: 'https://git.yourco.com' // URL to BitBucket
  ])
}
